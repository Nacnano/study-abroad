...
export default function Navigation() {
  ...
  return (
    <nav className="bg-linear-to-r from-slate-900 to-slate-800 dark:from-slate-950 dark:to-slate-900 border-b border-slate-700 dark:border-slate-800 shadow-2xl transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <GraduationCap className="w-8 h-8 text-blue-400 dark:text-blue-300" />
            <Link
              href="/"
